package com.haya.my_compose_sample.ui.screen.samples.theme_sample.model
 ...
 */
object PostRepo {
    fun getPosts(): List<SamplePost> = posts
    fun getFeaturedPost(): SamplePost = posts.random()
}
